            ...
            <div className="wrap container">
              ...
              <div className="form">
                <label>
                  ...
                  />
                  {error.name ? (
                    <p className="error_form"> {error.name} </p>
                  ) : null}
                </label>
                <label>
                  <p>
                  ...
                  />
                  {error.phone ? (
                    <p className="error_form"> {error.phone} </p>
                  ) : null}
                </label>
                <label>
                  <p>
                  ...
                  />
                  {error.email ? (
                    <p className="error_form"> {error.email} </p>
                  ) : null}
                </label>
                <label>
                  <p>
                ...
                <label className="disable">
                  ...
                  <select name="gender2" id="" onChange={inputChang}>
                    <option value="" selected={form.gender2 === ""}>
                      -- Vui lòng chọn--{" "}
                    </option>
                    <option value="basic" selected={form.gender2 === "basic"}>
                      Cơ bản{" "}
                    </option>
                    <option
                      value="advanced"
                      selected={form.gender2 === "Advanced"}
                    >
                      Nâng cao{" "}
                    </option>
                  </select>
                  ...
                  <div className="select">
                    ...
                    <div className="sub">
                      <a
                        ...
                        onClick={_payment.bind("chuyen-khoan")}
                      >
                        Chuyển khoản
                      </a>
                      <a
                        href="#"
                        data-value="tien-mat"
                        onClick={_payment.bind("tien-matt")}
                      >
                        Thanh toán tiền mặt
                      </a>
                    </div>
                ...
                <div className="btn main rect" onClick={_btnRegister}>
                  đăng ký
                </div>
              </div>
            </div>
